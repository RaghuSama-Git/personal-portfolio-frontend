...
import { Download, Github, Linkedin, Mail, MapPin, Calendar, Instagram } from "lucide-react";
...
Contact Information:
Email: raghusama99@gmail.com
Phone: +91 9885670911
Location: Hyderabad, India

Professional Summary:
Passionate Java developer with 4 years of experience in Spring Boot, SQL, and MongoDB.
Currently working as Systems Engineer at TCS with expertise in building robust backend solutions.
...
Experience:
Systems Engineer at TCS (2023 - Present)
Java Developer at Smart IMS (2020 - 2023)
...
- Cricket
  ...
  return (
    <section id="home" className="min-h-screen pt-20 pb-16 px-4 bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 min-h-[80vh]">
          ...
          <div className="flex-1 max-w-md lg:max-w-lg order-1 lg:order-1">
            <div className="relative">
              ...
              {/* Main photo container with new design */}
          ...
          <div className="flex-1 text-center lg:text-left space-y-8 order-2 lg:order-2">
            {/* Greeting with new styling */}
            <div className="space-y-4">
              <div className="inline-block">
                <p className="text-lg text-emerald-300 font-medium tracking-wide mb-2">Hello World! 👋</p>
            ...
            {/* Professional Info Cards with new design */}
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <p className="text-lg text-gray-200 leading-relaxed">
                Passionate Java developer at <span className="text-emerald-300 font-semibold">TCS</span> specializing in 
                <span className="text-cyan-300 font-semibold"> Spring Boot</span>, 
